-- Remove existing global unique constraints that are causing issues
DROP INDEX IF EXISTS unique_pf_number_employees;
DROP INDEX IF EXISTS unique_esi_number_employees;  
DROP INDEX IF EXISTS unique_pan_card;
